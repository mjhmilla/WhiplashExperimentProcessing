...
for indexParticipantCount=1:1:participantCount
    ...
    if(flag_runScaleTool==1)    	      
        ...
        modelMassKeyWord        = '<mass>';
        modelMassReplacement    = sprintf('<mass>%1.1f</mass>',...
                                           participantData.weight);

        modelHeightKeyWord        = '<height>';
        modelHeightReplacement    = sprintf('<height>%1.1f</height>',...
                                            participantData.height*10.0);

        modelAgeKeyWord        = '<age>';
        modelAgeReplacement    = sprintf('<age>%1.1f</age>',...
                                           participantData.age);
        ...
        replacementLines = ...
            {modelNameReplacement;...
             modelMassReplacement;...
             modelHeightReplacement;...
             modelAgeReplacement;...
